    ...
    return ToolsSchema(standard_tools=[
        ...
        FunctionSchema(
            ...
            properties={
                ...
                "appointment_date": {"type": "string", "description": "Date as YYYY-MM-DD"},
                "start_time": {"type": "string", "description": "Time as HH:MM (24h format)"},
                "notes": {"type": "string", "description": "Reason for visit or other notes"},
            },
            required=["doctor_id", "patient_name", "patient_phone", "appointment_date", "start_time"],
        ),
        FunctionSchema(
